...
- [ ] **YouTube OAuth token** — Is `/media/dan/fdrive/marcus/.youtube_token.json` present and not expired? If the token refresh fails, flag it immediately — nothing works without auth.
